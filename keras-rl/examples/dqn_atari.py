...
from keras.layers import Dense, Activation, Flatten, Convolution2D, Permute, LSTM
...
dqn = DQNAgent(model=model, nb_actions=nb_actions, policy=policy, memory=memory,
               processor=processor, nb_steps_warmup=8096, gamma=.99, target_model_update=10000,
...
if args.mode == 'train':
    ...
    dqn.load_weights(os.getcwd()+'/good.h5f')
